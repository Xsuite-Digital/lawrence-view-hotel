...
//             <Hotel className="text-[#c4a053]" size={40} />
...
//           {/* Feature 2 */}
//           <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center">
//             <Bell className="text-[#c4a053]" size={40} />
//             <h3 className="text-xl font-semibold mt-4">24/7 Concierge</h3>
//             <p className="text-gray-600 text-center mt-2">
...
//           {/* Feature 3 */}
//           <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center">
//             <Star className="text-[#c4a053]" size={40} />
//             <h3 className="text-xl font-semibold mt-4">Award-Winning Hospitality</h3>
//             <p className="text-gray-600 text-center mt-2">
...
//           {/* Feature 4 */}
//           <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center">
//             <MapPin className="text-[#c4a053]" size={40} />
...
// Features Data (Mapped for Optimization)
const features = [
